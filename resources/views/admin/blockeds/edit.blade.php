                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">IP-адрес</a></li>
        ...
        <section class="content">
            <div class="col-md-6">
                <div class="card card-outline card-primary">
                    ...
                    <form method="POST" action="{{ route('admin.blockeds.update', ['blocked' => $blocked->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                    ...
                    <form id="deleteForm" class="d-none"
                        action="{{ route('admin.blockeds.destroy', ['blocked' => $blocked->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
