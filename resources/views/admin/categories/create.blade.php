        ...
        <section class="content">
            <div class="col-md-6 mx-auto">
                <div class="card card-outline card-primary">
                    ...
                    <form method="POST" action="{{ route('categories.store') }}" id="quickForm" novalidate="novalidate">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="Новая категория" aria-describedby="InputText-error" aria-invalid="true">
