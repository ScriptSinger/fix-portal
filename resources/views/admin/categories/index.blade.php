                        ...
                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <table id="dataTable" class="table table-bordered table-striped dataTable dtr-inline w-100"
                                ...
                                data-routes='{
                                    ...
                                    "destroy": "{{ route('api.categories.destroy', ['category' => ':id']) }}",
                                    "restore": "{{ route('api.categories.restore', ['category' => ':id']) }}"
                                }'>
                            </table>
                        </div>
                    </div>
...
@push('scripts')
    <script src="{{ asset('assets/admin/js/custom/datatables/categories.js') }}"></script>
@endpush
