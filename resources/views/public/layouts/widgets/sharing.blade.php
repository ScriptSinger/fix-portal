<div class="post-sharing">
    <ul class="list-inline">
        <li><a href="https://vk.com/share.php?url={{ route('articles.show', ['article' => $reference]) }}"
        ...
        <li><a href="https://telegram.me/share/url?url={{ route('articles.show', ['article' => $reference]) }}"
                class="tw-button btn btn-primary" target="_blank"><i class="fa fa-telegram"></i>
                <span class="down-mobile">Поделиться</span></a></li>

        <li><a href="https://web.whatsapp.com/send?text={{ route('articles.show', ['article' => $reference]) }}"
                class="whatsapp-button btn btn-primary" target="_blank"><i class="fa fa-whatsapp"></i></a>
        </li>
        <li><a data-url="{{ route('articles.show', ['article' => $reference]) }}" href="#"
