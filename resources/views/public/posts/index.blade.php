                        ...
                        <div class="page-wrapper">
                            <div class="blog-custom-build">
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_01.jpg') }}"
                                                alt="" class="img-fluid">
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_02.jpg') }}"
                                                alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_03.jpg') }} "
                                                alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_04.jpg') }}"
                                                alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_05.jpg') }}"
                                                alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="{{ asset('assets/front/upload/market_blog_06.jpg') }}"
                                                alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                        ...
                        <div class="sidebar">
                                    ...
                                    <div class="list-group">
                                        <a href="marketing-single.html"
                                            ...
                                            <div class="w-100 justify-content-between">
                                                <img src="{{ asset('assets/front/upload/small_07.jpg') }}"
                                        ...
                                        <a href="marketing-single.html"
                                            class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between">
                                                <img src="{{ asset('assets/front/upload/small_08.jpg') }} "
                                                    alt="" class="img-fluid float-left">
                                        ...
                                        <a href="marketing-single.html"
                                            ...
                                            <div class="w-100 last-item justify-content-between">
                                                <img src="{{ asset('assets/front/upload/small_09.jpg') }}"
                                                    alt="" class="img-fluid float-left">
                            ...
                            <div class="widget">
                                ...
                                <div class="instagram-wrapper clearfix">
                                    <a class="" href="#"><img
                                            src="{{ asset('assets/front/upload/small_09.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_01.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_02.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_03.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_04.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_05.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_06.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_07.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <a href="#"><img src="{{ asset('assets/front/upload/small_08.jpg') }}"
                                            alt="" class="img-fluid"></a>
